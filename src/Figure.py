...
class Figure:
    ...
    def get_perimeter(self) -> float:
        for i in self.__base_figs_perimeters:
            if i == self._get_class_name(self):
                return self.__base_figs_perimeters[i](list(self.__dict__.values()))

    @property
    def get_area(self) -> float:
        for i in self.__base_figs_areas:
            if i == self._get_class_name(self):
                return self.__base_figs_areas[i](list(self.__dict__.values()))
