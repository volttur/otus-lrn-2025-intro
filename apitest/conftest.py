...
def pytest_addoption(parser):
    parser.addoption("--url", action="store", default="https://ya.ru", help="Setting up url for the test")
    parser.addoption("--status_code", action="store", default="200", help="Setting up status code for the test")
